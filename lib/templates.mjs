...
export const EMERGENCY_POOL = [
  ...
  // these keep the run from ever ending empty-handed even with zero AI).
  {
    ...
    params: { title: 'Reverse Text', h1: 'Reverse Text — flip any string backwards', transforms: ['reverse-text'], rows: 8 },
    popularity: 48
  },
  {
    id: 'title-case-tool',
  ...
  },
  {
    ...
    params: { title: 'Extract Emails', h1: 'Extract Emails from any text', transforms: ['extract-emails'], rows: 8 },
    popularity: 54
  },
  {
    id: 'sort-lines-tool',
    ...
    params: { title: 'Sort Lines', h1: 'Sort Lines — alphabetize any list', transforms: ['sort-lines'], rows: 8 },
    popularity: 46
  },
  {
    ...
    params: { title: 'Remove Duplicate Lines', h1: 'Remove Duplicate Lines', transforms: ['dedupe-lines'], rows: 8 },
    popularity: 49
  }
];